...
class Yakindu_Spec(TestCase):
    ...
    def test_if_lean_content_was_created(self):
        self.parser._create_cleaned_content() |should| equal_to([[['initial_state', 'refrigerator', 'door', 'closed'], ['specification', 'light', 'off', 'true'], ['specification', 'light', 'on', 'false'], ['specification', 'thermostat', 'power', 'minimum', 'true'], ['specification', 'thermostat', 'power', 'maximum', 'false']], [['transition', 'opens', 'door'], ['state', 'door', 'opened'], ['specification', 'light', 'on', 'true'], ['specification', 'light', 'off', 'false'], ['specification', 'thermostat', 'power', 'maximum', 'true'], ['specification', 'thermostat', 'power', 'minimum', 'false']], [['transition', 'closes', 'door'], ['state', 'refrigerator', 'door', 'closed']]])
    
    def test_if_content_was_classified(self):
        self.parser._pos_tag_lean_content() |should| equal_to([[[('initial_state', None), ('refrigerator', 'NN'), ('door', 'NN'), ('closed', 'VBD')], [('specification', None), ('light', 'JJ'), ('off', 'RP'), ('true', 'JJ')], [('specification', None), ('light', 'JJ'), ('on', 'IN'), ('false', None)], [('specification', None), ('thermostat', None), ('power', 'NN'), ('minimum', 'JJ'), ('true', 'JJ')], [('specification', None), ('thermostat', None), ('power', 'NN'), ('maximum', 'NN'), ('false', None)]], [[('transition', 'NN'), ('opens', 'VBZ'), ('door', 'NN')], [('state', 'NN'), ('door', 'NN'), ('opened', 'VBD')], [('specification', None), ('light', 'JJ'), ('on', 'IN'), ('true', 'JJ')], [('specification', None), ('light', 'JJ'), ('off', 'RP'), ('false', None)], [('specification', None), ('thermostat', None), ('power', 'NN'), ('maximum', 'NN'), ('true', 'JJ')], [('specification', None), ('thermostat', None), ('power', 'NN'), ('minimum', 'JJ'), ('false', None)]], [[('transition', 'NN'), ('closes', None), ('door', 'NN')], [('state', 'NN'), ('refrigerator', 'NN'), ('door', 'NN'), ('closed', 'VBD')]]])
    
    def test_if_the_term_specification_was_removed_from_content_and_if_trasition_was_lemmatized(self):
        ...
        self.parser._clean_pos_tagged_content(second_sent) |should| equal_to([['transition'], ['open', 'door'], ['state'], ['door'], ['opened'], ['specification'], ['light'], ['turns', 'on'], ['specification'], ['thermostat', 'power', 'maximum']])
        self.parser._clean_pos_tagged_content(third_sent) |should| equal_to([['transition'], ['close', 'door'], ['state'], ['refrigerator'], ['door'], ['closed']])

    def test_if_content_was_cleaned(self):
        self.parser._create_cleaned_content() |should| equal_to([[['initial_state', 'refrigerator', 'door', 'closed'], ['specification', 'light', 'off', 'true'], ['specification', 'light', 'on', 'false'], ['specification', 'thermostat', 'power', 'minimum', 'true'], ['specification', 'thermostat', 'power', 'maximum', 'false']], [['transition', 'opens', 'door'], ['state', 'door', 'opened'], ['specification', 'light', 'on', 'true'], ['specification', 'light', 'off', 'false'], ['specification', 'thermostat', 'power', 'maximum', 'true'], ['specification', 'thermostat', 'power', 'minimum', 'false']], [['transition', 'closes', 'door'], ['state', 'refrigerator', 'door', 'closed']]])
    
    def test_if_states_were_exchanged(self):
        self.parser.exchange_states() |should| equal_to([[['initial_state', 'refrigerator', 'door', 'closed'], ['specification', 'light', 'off', 'true'], ['specification', 'light', 'on', 'false'], ['specification', 'thermostat', 'power', 'minimum', 'true'], ['specification', 'thermostat', 'power', 'maximum', 'false']], [['transition', 'opens', 'door'], ['state', 'door', 'opened'], ['specification', 'light', 'on', 'true'], ['specification', 'light', 'off', 'false'], ['specification', 'thermostat', 'power', 'maximum', 'true'], ['specification', 'thermostat', 'power', 'minimum', 'false']], [['transition', 'closes', 'door'], ['initial_state', 'refrigerator', 'door', 'closed']]])
