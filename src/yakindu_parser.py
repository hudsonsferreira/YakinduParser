...
class YakinduParser(object):
    ...
    def __init__(self, path):
        ...
        self._content_directory = tempfile.mkdtemp(prefix="YakinduDirectory")
        self._file_name = self._content_directory + '/content.xml'

    def _valid_mimetype(self, path):
        return magic.from_file(path, mime=True) == 'application/vnd.oasis.opendocument.text'
    ...
    def _clean_content(self):
        ...
        print 'tiny raw content'
        print tiny_raw_content
        return tiny_raw_content

    def _remove_directory(self):
        #import ipdb; ipdb.set_trace()
        shutil.rmtree(self._content_directory)
